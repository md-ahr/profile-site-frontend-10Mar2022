  ...
  const getExperienceById = async () => {
    try {
      const res: AxiosResponse<any> = await axios.get(
        `${BASE_API_URL}/experiences/${props.id}`,
  ...
  return (
    <>
      <button
        type="button"
        onClick={onOpenModal}
        className="text-blue-500 basis-[3%] border-2 border-blue-500 px-3 py-2 rounded hover:bg-blue-600 hover:text-blue-100 transition ease duration-500"
      >
        <FaRegEdit />
      </button>
        ...
        <div className="mt-4">
          <div className="mb-3">
            ...
            <input
              ...
              className="shadow appearance-none border rounded text-sm w-full py-2 px-3 text-grey-darker mb-2"
              id="companyName"
              type="text"
            />
          </div>
          ...
          <div className="mb-4">
            <div className="form-check">
              <input
                ...
                className="form-check-input border w-4 h-4 border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                type="checkbox"
                id="check"
              />
              <label
          ...
          <button
            ...
            className="bg-green-500 text-white font-bold w-full py-2 rounded"
          >
            Update
          </button>
        </div>
