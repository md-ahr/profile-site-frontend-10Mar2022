  ...
  return (
    <>
      <button
        type="button"
        onClick={onOpenModal}
        className="text-sm font-bold text-green-500 border-2 border-green-500 px-4 py-2 mt-2 rounded hover:bg-green-600 hover:text-white transition ease duration-500"
      >
        Update Bio
      </button>
